...
def projection_block(A_prev, filters, s=2):
    ...
    c_1 = K.layers.Conv2D(filters=F11, kernel_size=1, strides=s,
                          padding='same',
    ...
    c1_proj = K.layers.Conv2D(filters=F12, kernel_size=1, strides=s,
                              padding='same',
                              kernel_initializer=init)(A_prev)

    b3 = K.layers.BatchNormalization(axis=3)(c_3)

    b4 = K.layers.BatchNormalization(axis=3)(c1_proj)
